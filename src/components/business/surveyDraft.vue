        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters">
                ...
                <el-form-item>
					...
					<el-button class="sign-tit" type="primary" @click="printForm">打印调样签收表</el-button>
						
							<div id="table1" style="display:none;width:100%;">
								<h2 style="text-align:center">调样签收表</h2>
								<el-table :data="tableData1" border class='marginBottom' width="100%">
										<el-table-column prop="date" label="调样日期" width=""></el-table-column>
										<el-table-column prop="season" label="季节" width=""></el-table-column>
										<el-table-column prop="person" label="调样人" width=""></el-table-column>
										<el-table-column prop="supplier" label="供应商" width=""></el-table-column>
										<el-table-column prop="supplierName" label="调样货号" width=""></el-table-column>
										<el-table-column prop="meterNum" label="调样米数" width=""></el-table-column>
										<el-table-column prop="time" label="到样时间" width=""></el-table-column>
										<el-table-column prop="num" label="到样数量" width=""></el-table-column>
										<el-table-column prop="name" label="设计师签字" width=""></el-table-column>
								</el-table>
						</div>    
        ...
        <el-dialog title="调样需求编辑" v-model="formEdit" :close-on-click-modal="false" custom-class='el-dialog--large'>
            <el-form :inline="true" :model="filters">
                ...
                <div class='center'>
                    ...
                    <el-button type="primary" v-on:click="">保存草稿</el-button>
                </div>
            </el-form>
        </el-dialog>
        <!-- 图片上传对话框 -->
    ...
    methods: {
        ...
        uploadPic22: function() {
    	 ...
    	 printForm(){
    	            ...
    	            // //这里的“yangshi"是样式表的ID，如  <style type="text/css" id="table-style"></style>
    	            // var strFormHtml = strBodyStyle + "<body>" + document.getElementById("signDataForm").innerHTML + "</body>";
    	            // //这里的”signDataForm“是标签的名称。
    	           ...
    	           var LODOP=getLodop();
    	            var strBodyStyle="<style>table{border-collapse: collapse;border:1px solid #000;width:100%;}th{border-collapse: collapse;border:1px solid #000;text-align:center;}td {border:1px solid #000;text-align:center;border-collapse: collapse;} </style>";
    	            var strFormHtml=strBodyStyle+"<body>"+document.getElementById("table1").innerHTML+"</body>";
    	            LODOP.PRINT_INIT("打印控件功能演示_Lodop功能_样式风格");
    	            LODOP.SET_PRINT_STYLE("FontSize",18);
    	            LODOP.SET_PRINT_STYLE("Bold",1);
    	            
    	            //LODOP.ADD_PRINT_TEXT(50,50,300,200,"细线样式打印：");
    	            LODOP.ADD_PRINT_HTM(88,50,300,200,strFormHtml);
    	            LODOP.PREVIEW();
    	},
